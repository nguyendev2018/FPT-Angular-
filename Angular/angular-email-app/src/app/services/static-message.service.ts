...
export class StaticMessageService {
    messages: MessageModel[] = [
        ...
        },
        {
            ...
            subject:
                'And this explains the brighter aspect of the Great Rings.',
        ...
        },
        {
            ...
            subject:
                'Into two great hostile camps, into its paid wage labourers..',
        ...
        },
        {
            ...
            subject:
                'A doubt. The PlainBelly SneetchesHad none upon thars. When.',
        ...
        },
        {
            ...
            subject:
                'Went into his face, quiet, intent upon me, said the Doctor.',
        ...
        },
        {
            ...
            subject:
                'VIII. A lifethirsting, canniballooking, bloodyminded juryman.',
        ...
        },
        {
            ...
            subject:
                'On, as you probably guess, Things really got into a horrible.',
        ...
        },
        {
            ...
            subject:
                'Of us. The gracious Duncan have I murderd Put rancours in the.',
    ...
    getFolders(): string[] {
        let folders = this.messages.map((message) => {
            return message.folder;
        });
        folders.push('draft', 'sent');
        return [...new Set(folders)];
    }

    getListMsg(folderName: string): MessageModel[] {
        return this.messages.filter((message) => {
            return message.folder == folderName;
        });
    }

    getMsgById(id: string): MessageModel {
