...
$route['addNewProduct'] = "user/addNewProduct";
$route['addNewProducts'] = "user/addNewProducts";
$route['editOldProduct/(:num)'] = "user/editOldProduct/$1";
$route['editProduct'] = "user/editProduct";
$route['deleteProduct/(:num)'] = "user/deleteProduct/$1";

$route['blog'] = "user/blog";
$route['addNewBlog'] = "user/addNewBlog";
$route['addNewBlogs'] = "user/addNewBlogs";
$route['editOldBlog/(:num)'] = "user/editOldBlog/$1";
$route['editBlog'] = "user/editBlog";
