...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_product as ProTbl');
        $this->db->join('tbl_users as Users','Users.userId = ProTbl.createdBy');
        $this->db->join('tbl_roles as Roles','Roles.roleId = Users.roleId');
        $this->db->join('tbl_category as Category','Category.id = ProTbl.id');
        $this->db->order_by('ProTbl.id ASC, ProTbl.pro_id');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
    ...
    /**
     * This function is used to get product category
     */
     ...
     */
    function addNewProducts($productInfo)
    {
        $this->db->trans_start();
     ...
     * @param number $pro_id : This is product id
    ...
    function getProductInfo($productId)
    {
        ...
        $this->db->join('tbl_category as Category','Category.id = tbl_product.id');
    ...
    /**
     * This function is used to complete products
     */
    function endProduct($productId, $productInfo)
    {
        $this->db->where('pro_id', $productId);
        $this->db->update('tbl_product', $productInfo);
        ...
        return $this->db->affected_rows();
            ...
            /**
     * This function is used to get the products count
     * @return array $result : This is result
     */
    ...
    /**
     * This function is used to get the finished products count
     * @return array $result : This is result
     */
    function finishedProductsCount()
    {
        $this->db->select('*');
        $this->db->from('tbl_product as BaseTbl');
        $this->db->where('BaseTbl.id', 2);
        $query = $this->db->get();
        return $query->num_rows();
    }

        /**
     * This function is used to get blogs
     */
    function getBlogs()
    {
        $this->db->select('*');
        $this->db->from('tbl_blog as BlogTbl');
        $this->db->join('tbl_users as Users','Users.userId = BlogTbl.createdBy');
        $this->db->join('tbl_roles as Roles','Roles.roleId = Users.roleId');
        $this->db->join('tbl_category as Category','Category.id = BlogTbl.id');
        $this->db->order_by('BlogTbl.id ASC, BlogTbl.blog_id');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
    ...
    /**
     * This function is used to get blog category
     */
    ...
    /**
     * This function used to get blog information by id
     * @param number $blog_id : This is blog id
     * @return array $result : This is blog information
     */
    function getBlogInfo($blogId)
    {
        $this->db->select('*');
        $this->db->from('tbl_blog');
        $this->db->join('tbl_category as Category','Category.id = tbl_blog.id');
    ...
    /**
     * This function is used to complete blogs
     */
    function endBlog($blogId, $blogInfo)
    {
        $this->db->where('blog_id', $blogId);
        $this->db->update('tbl_blog', $blogInfo);
        ...
        return $this->db->affected_rows();
            ...
            /**
     * This function is used to get the blogs count
     * @return array $result : This is result
     */
    function blogsCount()
    {
    ...
    /**
     * This function is used to get the finished blogs count
     * @return array $result : This is result
     */
    function finishedBlogsCount()
    {
        $this->db->select('*');
        $this->db->from('tbl_blog as BaseTbl');
        $this->db->where('BaseTbl.id', 2);
