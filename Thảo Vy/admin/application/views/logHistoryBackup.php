<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-archive"></i> Lịch sử nhật ký sao lưu
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"> Kích thước bảng Nhật ký sao lưu của bạn:
              <?php
            ...
            <div class="pull-right">
              <a class="btn btn-danger" href="<?php echo base_url(); ?>backupLogTableDelete">Xóa bảng dự trữ</a>
            </div>
            <div class="box-tools">
            </div>
          </div>
