...
if(!empty($blogInfo))
{
    foreach ($blogInfo as $uf)
    {
        $blog_id = $uf->blog_id;
        $blog_tittle = $uf->blog_tittle;
        $blog_content = $uf->blog_content;
        $id = $uf->id;
        $blog_img = $uf->blog_img;
    }
}
?>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" id="addNewBlogt" action="<?php echo base_url() ?>editBlog" enctype="multipart/form-data" method="post" role="form">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" value="<?php echo $blog_tittle; ?>" id="blog_tittle" name="blog_tittle">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="blog_content" name="blog_content1">
