...
<div class="container" style="width: 80%;max-width: 90%;padding: 0;min-width: 0;margin: 0 auto;height: auto;">
    ...
    <div class="col d-block float-left" style="width: 49%;height: auto;padding: 0;">
        ...
        <button id="AddToCartFullInfo" class="btn btn-primary d-block float-left" type="button" style="width: 60%;height: 48px;">Thêm vào giỏ hàng</button>
    </div>
    <div class="clearfix"></div>
</div>
<footer class="copyright" style="height: 80px;">
    <div class="content"> Created With <i style="color: #e74c3c" class="fas fa-heart"></i> By Lê Minh Sơn &copy; 2020 <br> QGarden Owned By LMSQ Group &copy; 2020
    </div>
</footer>
