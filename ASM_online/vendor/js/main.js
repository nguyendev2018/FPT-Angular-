...
for (var i = 0; i < nut.length; i++) {
    nut[i].addEventListener("click", function () {
        ...
        current_show.querySelector(".btn-cancel").onclick = function(e) {
            document.querySelector('.black').classList.remove('hint-black');
            current_show.classList.remove("show_hidden");
            btnNut.classList.remove("blue");
            this.onclick = null;
            current_show.querySelector(".btn-save").onclick = null;
        }
        current_show.querySelector(".btn-save").onclick = function(e) {
            document.querySelector('.black').classList.remove('hint-black');
            current_show.classList.remove("show_hidden");
            btnNut.classList.remove("blue");
            this.onclick = null;
            current_show.querySelector(".btn-cancel").onclick = null;
        }
